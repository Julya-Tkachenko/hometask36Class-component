...
var Smiles = function Smiles() {
  var _useState = (0,react.useState)(function () {
      return JSON.parse(localStorage.getItem("emojis")) || smilesData;
    }),
  ...
  var onVoteSmile = function onVoteSmile(id) {
    var updateEmojis = emojis.map(function (el) {
  ...
  var onClear = function onClear() {
    var defaultValues = emojis.map(function (el) {
      return _objectSpread(_objectSpread({}, el), {}, {
        count: 0
      });
    });
    setEmojis(defaultValues);
    setResult(null);
  };
  var onShowResult = function onShowResult() {
    var maxValueObj = emojis.reduce(function (max, obj) {
      return obj.count > max.count ? obj : max;
    }, emojis[0]);
    setResult(maxValueObj.count !== 0 ? maxValueObj : null);
  };
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("div", {
    className: "smiles-group"
  }, emojis.map(function (_ref) {
    var id = _ref.id,
      label = _ref.label,
      count = _ref.count;
  ...
  }, "Show result")), result && /*#__PURE__*/react.createElement("div", {
    className: "smiles-result"
  }, /*#__PURE__*/react.createElement("div", null, "\u041F\u0435\u0440\u0435\u043C\u043E\u0436\u0435\u0446\u044C:"), result.label, " : ", result.count));
};
