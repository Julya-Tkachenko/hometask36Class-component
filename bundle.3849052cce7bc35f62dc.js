...
var Smiles = /*#__PURE__*/function (_Component) {
  function Smiles(props) {
    var _this;
    _classCallCheck(this, Smiles);
    _this = _callSuper(this, Smiles, [props]);
    _defineProperty(_this, "onVoteSmile", function (id) {
      var updateEmojis = _this.state.emojis.map(function (el) {
    ...
    _defineProperty(_this, "onClear", function () {
      var defaultValues = _this.state.emojis.map(function (el) {
    ...
    _defineProperty(_this, "onShowResult", function () {
      var maxValueObj = _this.state.emojis.reduce(function (max, obj) {
        return obj.count > max.count ? obj : max;
      }, _this.state.emojis[0]);
      _this.setState(_objectSpread(_objectSpread({}, _this.state), {}, {
        result: maxValueObj.count !== 0 ? maxValueObj : null
      }));
    });
    _this.state = {
  ...
  _inherits(Smiles, _Component);
  return _createClass(Smiles, [{
    key: "render",
    value: function render() {
      var _this2 = this;
      var elements = this.state.emojis.map(function (_ref) {
        var id = _ref.id,
          label = _ref.label,
          count = _ref.count;
        return /*#__PURE__*/react.createElement("span", {
          key: id,
          className: "smiles-group-item"
        }, /*#__PURE__*/react.createElement("span", {
          onClick: function onClick() {
            return _this2.onVoteSmile(id);
          }
        }, label), /*#__PURE__*/react.createElement("span", null, count));
      });
      var result = null;
      if (this.state.result) {
        result = /*#__PURE__*/react.createElement("div", {
          className: "smiles-result"
        }, /*#__PURE__*/react.createElement("div", null, "\u041F\u0435\u0440\u0435\u043C\u043E\u0436\u0435\u0446\u044C"), this.state.result.label, " : ", this.state.result.count);
      }
      return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement("div", {
        className: "smiles-group"
      }, elements), /*#__PURE__*/react.createElement("div", {
        className: "smiles-wrapper"
      }, /*#__PURE__*/react.createElement("button", {
        className: "smiles-btn",
        onClick: function onClick() {
        ...
        className: "smiles-btn",
        onClick: function onClick() {
          return _this2.onShowResult();
        }
      }, "Show result")), result);
    }
  }]);
}(react.Component);
/* harmony default export */ const smiles = (Smiles);
;// ./src/index.js
...
var App = function App() {
  var smilesData = JSON.parse(localStorage.getItem("emojis")) || [{
    label: '😀',
    count: 0,
    id: 1
  }, {
  ...
  return /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(app_header, null), /*#__PURE__*/react.createElement(smiles, {
    smiles: smilesData
  }));
};
var rootNodeElement = document.querySelector('#main');
var root = client.createRoot(rootNodeElement);
